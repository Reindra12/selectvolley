...
// || empty($tglm) || empty($nis) || empty($jam) || empty($kegiatan) || empty($lokasi) || empty($user)		
if(empty($fileName) ){
...
if(!isset($errorMSG))
{
	$query = mysqli_query($conn,'INSERT into tbl_image (name,tgl,nis,jam,kegiatan,lokasi,user) VALUES("'.$fileName.'","'.$tglm.'","'.$nis.'","'.$jam.'","'.$kegiatan.'","'.$lokasi.'","'.$user.'")');
